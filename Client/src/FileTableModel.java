...
public class FileTableModel extends DefaultTableModel {
	...
	public void addFile(Files t, SwingWorker worker) {
		Object[] obj = { t.getID(), t.getName(), t.getSize(), t.getRate(),
				t.getProgress(), t.getClientAddr(), t.getHash(), t.getStatus() };
		// t.setid(number);
		super.addRow(obj);
...
class Files {
	...
	public Files(Integer ID, String Name, String Size, String Rate,
			Integer Progress, String ClientAddr, String Hash, String Status) {
		this.ID = ID;
		this.Name = Name;
		this.Rate = Rate;

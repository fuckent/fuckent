...
public class FileTableModel extends DefaultTableModel {
    ...
    private static final ColumnContext[] columnArray = {
        ...
        new ColumnContext("Rate", Integer.class, false),
    ...
    public File getFile(int identifier) {
        return new File((Integer) getValueAt(identifier, 0), (String) getValueAt(identifier, 1), (Integer) getValueAt(identifier, 2),
                (Integer) getValueAt(identifier, 3), (String) getValueAt(identifier, 4), (String) getValueAt(identifier, 5), (String) getValueAt(identifier, 6));
    }
...
class File {
    ...
    public File(Integer ID, String Name, Integer Rate, Integer Progress, String ClientAddr, String Hash, String Status) {
        this.ID = ID;
        this.Name = Name;
        this.Rate = Rate;
    ...
    public void setRate(Integer str) {
        Rate = str;
    }
